...
default_loc = default_data_raw_dir/"S3Eval-long8k.json"

dataset_info = {
        "name": "S3Eval-long8k", 
        "des": """S3Eval long8k dataset contains long level questions from S3Eval.""",
        "dataset_type": ""
    }

class S3EvalLong8k(Dataset):
...
def get_default_dataset():
    return S3EvalLong8k(loc=default_loc)
