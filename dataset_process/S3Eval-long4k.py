...
default_loc = default_data_raw_dir/"S3Eval-long4k.json"

dataset_info = {
        "name": "S3Eval-long4k", 
        "des": """S3Eval long4k dataset contains long level questions from S3Eval.""",
        "dataset_type": ""
    }

class S3EvalLong4k(Dataset):
...
def get_default_dataset():
    return S3EvalLong4k(loc=default_loc)
