...
default_loc = default_data_raw_dir/"S3Eval-easy.json"

dataset_info = {
        "name": "S3Eval-easy", 
        "des": """S3Eval easy dataset contains easy level questions from S3Eval.""",
        "dataset_type": ""
    }

class S3EvalEasy(Dataset):
...
def get_default_dataset():
    return S3EvalEasy(loc=default_loc)
