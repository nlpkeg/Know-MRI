...
default_loc = default_data_raw_dir/"opus_books_ca_de.json"
dataset_info = {
    "name": "Opus Books_ca_de",
    "des":"Opus Books_ca_de includes sentences with the same meaning but in different languages.",
    "dataset_type": ""
}
