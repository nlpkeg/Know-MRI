...
default_loc = default_data_raw_dir/"TimeReasoningScope.json"

dataset_info = {
        "name": "TimeReasoningScope", 
        "des": """Time interval event knowledge data for temporal reasoning domain.""",
        "dataset_type": ""
    }

class TimeReasoningScope(Dataset):
...
def get_default_dataset():
    return TimeReasoningScope(loc=default_loc)
