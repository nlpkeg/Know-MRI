...
default_loc = default_data_raw_dir/"S3Eval-long2k.json"

dataset_info = {
        "name": "S3Eval-long2k", 
        "des": """S3Eval long2k dataset contains long level questions from S3Eval.""",
        "dataset_type": ""
    }

class S3EvalLong2k(Dataset):
...
def get_default_dataset():
    return S3EvalLong2k(loc=default_loc)
