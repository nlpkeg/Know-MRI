...
default_loc = default_data_raw_dir/"opus_books_ca_hu.json"
dataset_info = {
    "name": "Opus Books_ca_hu",
    "des":"Opus Books_ca_hu includes sentences with the same meaning but in different languages.",
    "dataset_type": ""
}
