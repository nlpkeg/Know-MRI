...
default_loc = default_data_raw_dir/"pararel.json"

dataset_info = {
        "name": "PARAREL", 
        "des": """PARAREL is curated by experts, containing various prompt templates for 38 relations from the T-REx datase.""",
        "dataset_type": ""
    }
...
def get_default_dataset():
    return PARARELDataset(loc=default_loc)
