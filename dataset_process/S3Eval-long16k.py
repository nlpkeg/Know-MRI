...
default_loc = default_data_raw_dir/"S3Eval-long16k.json"

dataset_info = {
        "name": "S3Eval-long16k", 
        "des": """S3Eval long16k dataset contains long level questions from S3Eval.""",
        "dataset_type": ""
    }

class S3EvalLong16k(Dataset):
...
def get_processed_kvs(sample, keys=support_template_keys):
    ...
    kvs["prompt"] = sample["input"]
    kvs["ground_truth"] = sample["sql"]
    return kvs


def get_default_dataset():
    return S3EvalLong16k(loc=default_loc)
