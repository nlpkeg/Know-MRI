...
default_loc = default_data_raw_dir/"TimeReasoningCounterfactual.json"

dataset_info = {
        "name": "TimeReasoningCounterfactual", 
        "des": """Time counterfactual event knowledge data for temporal reasoning domain.""",
        "dataset_type": ""
    }

class TimeReasoningCounterfactual(Dataset):
...
def get_default_dataset():
    return TimeReasoningCounterfactual(loc=default_loc)
