...
default_loc = default_data_raw_dir/"Zhujiu-Commonsense.json"

dataset_info = {
        "name": "Zhujiu-Commonsense", 
        "des": """Zhujiu Commonsense dataset contains commonsense knowledge questions from Zhujiu Knowledge.""",
        "dataset_type": ""
    }

class ZhujiuCommonsense(Dataset):
...
def get_processed_kvs(sample, keys=support_template_keys):
    ...
    kvs["prompts"] = [question + " " + choice_data_str for question in sample["questions"]]
...
def get_default_dataset():
    return ZhujiuCommonsense(loc=default_loc)
